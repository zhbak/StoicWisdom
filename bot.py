...
def send_message():
    ...
    system = f"Вы философ. Предоставьте короткий комментарий по цитате и фразе. Комментарий должен быть понятным и доступным, кратким.\
             ...
             что циатата/идея является центральной, основной ключевой и т.д. Не пишите 'цитата:', 'Комментарий:'. Ответ предоставляй в разметке html и на русском языке в кодировке UTF-8"
